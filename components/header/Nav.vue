...
<template>
  <div class="bg-white">
    ...
    <header class="relative bg-white">
      ...
      <nav aria-label="Top" class="mx-auto px-4 sm:px-3 lg:px-3">
        <div class="border-b border-gray-200">
          <div class="flex h-16 items-center">
            ...
            <!-- Logo -->
            <div class="ml-2 flex lg:ml-0 sm:ml-0">
              <HeaderLogo />
            </div>
            ...
            <div class="ml-auto flex items-center">
              ...
              >
                ...
                <a
                  ...
                  >Create account</a
                >            
                <nuxt-link :to="localePath('/register')">{{ $t('registration.register') }}</nuxt-link>
                <HeaderLangSwitch />
              </div>
