<template>
    <footer class="footer" aria-labelledby="footer-heading">
      ...
      <div class="mx-auto max-w-7xl px-6 pb-4 pt-16 sm:pt-24 lg:px-8 lg:pt-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-sm font-semibold leading-6 text-gray-100">Solutions</h3>
              ...
              <div class="mt-10 md:mt-0">
                <h3 class="text-sm font-semibold leading-6 text-gray-100">Support</h3>
                <ul role="list" class="mt-2 space-y-1">
        ...
        <!-- bottom footer div -->
        <div class="mt-12 border-t border-gray-50/10 pt-4 sm:mt-20 lg:mt-4">
